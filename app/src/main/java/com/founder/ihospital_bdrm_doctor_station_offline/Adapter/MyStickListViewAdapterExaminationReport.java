 ...
 */
public class MyStickListViewAdapterExaminationReport extends BaseAdapter implements StickyListHeadersAdapter {


    private Context context;
    private List<DCCheckOfPatientHR.ValuesBean> data;
    private LayoutInflater inflater;

    private List<String> strData;
    private List<Integer> intData;
    public static final String TAG = MyStickListViewAdapterExaminationReport.class.getSimpleName();


    public MyStickListViewAdapterExaminationReport(Context context, List<DCCheckOfPatientHR.ValuesBean> data) {
    ...
    public void addRes(List<DCCheckOfPatientHR.ValuesBean> data) {
        Log.e(TAG, "addRes");
        if (data != null) {
    ...
    public void updateRes(List<DCCheckOfPatientHR.ValuesBean> data) {
        Log.e(TAG, "updateRes");
        if (data != null) {
            this.data.clear();
            this.data.addAll(data);
    ...
    private void deal(List<DCCheckOfPatientHR.ValuesBean> data) {
        Collections.sort(data, new Comparator<DCCheckOfPatientHR.ValuesBean>() {
            @Override
            public int compare(DCCheckOfPatientHR.ValuesBean lhs, DCCheckOfPatientHR.ValuesBean rhs) {
    ...
    private List<String> getStrData(List<DCCheckOfPatientHR.ValuesBean> data) {
...
//        }
    ...
    private List<Integer> getIntData(List<DCCheckOfPatientHR.ValuesBean> data) {
    ...
    public long getHeaderId(int position) {
        return Long.valueOf(dealString(data.get(position).getApplyDate()).replace("-", "")).longValue();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.content.setText(data.get(position).getType());
        return convertView;
    }
